...
@Component({
  selector: 'app-the-detail-content',
  templateUrl: './the-detail-content.component.html',
  styleUrls: ['./the-detail-content.component.scss'],
  animations: [
...
export class TheDetailContentComponent implements OnInit {
