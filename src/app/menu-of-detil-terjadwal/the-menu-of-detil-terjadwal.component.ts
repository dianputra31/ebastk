...
@Component({
  selector: 'app-the-menu-of-detil-terjadwal',
  templateUrl: './the-menu-of-detil-terjadwal.component.html',
  styleUrls: ['./the-menu-of-detil-terjadwal.component.scss']
})
export class TheMenuOfDetilTerjadwalComponent implements OnInit {
